        ...
        return (
            <>
                ...
                <div className="containerAbout" >
                    ...
                    <div style={{ width: '60vw', textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignContent: 'center', backgroundColor: '#f0f0f0' }}>
                        <h3>Our origins</h3>
                ...
                <div style={{ display: 'flex', margin: '5rem' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '60vw', justifyContent: 'center', backgroundColor: '#f0f0f0', padding: '2rem' }}>
                ...
                <div style={{ margin: '5rem 10%', textJustify: 'unset', backgroundColor: '#f0f0f0', padding: '2rem' }}>
